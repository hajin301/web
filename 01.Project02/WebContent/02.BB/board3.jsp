...
<ul class="nav nav-pills">
  ...
  <li class="nav-item dropdown">
    ...
    <div class="dropdown-menu">
      <a class="dropdown-item" href="list.do?page=<%=session.getAttribute("cpage") %>">전체보기</a>
      <a class="dropdown-item" href="board1.do?page=<%=session.getAttribute("cpage") %>">공지사항</a>
      <a class="dropdown-item" href="board2.do?page=<%=session.getAttribute("cpage") %>">자유게시판</a>
      <a class="dropdown-item" href="board3.do?page=<%=session.getAttribute("cpage") %>">자료실</a>
    </div>
  </li>
</ul>
